function isTargetURL(url) {
    return url && typeof url === 'string' && 
           (url.includes('chat.deepseek.com') || url.includes('genspark.ai'));
  }
...
function updateIcon(isRTL) {
    const iconPath = isRTL
        ? { "16": "icons/icon_rtl16.png", "48": "icons/icon_rtl16.png", "128": "icons/icon_rtl16.png" }
        : { "16": "icons/icon_rtl16.png", "48": "icons/icon_rtl16.png", "128": "icons/icon_rtl16.png" };
...
chrome.action.onClicked.addListener((tab) => {
    if (isTargetURL(tab.url)) {
        ...
        chrome.tabs.update(tab.id, { url: 'https://genspark.ai' });
    }
});
